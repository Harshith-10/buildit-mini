...
export default function StudentDashboard() {
    ...
    const allHackathons: Hackathon[] = [
        {
            ...
            description: "Develop an AI-powered solution to address a pressing social or environmental issue.",
            status: "Upcoming",
        ...
        },
        {
            ...
            description: "Build the next generation of decentralized applications on the blockchain.",
            status: "Upcoming",
        ...
        },
        {
            ...
            description: "Create scalable and resilient applications using modern cloud technologies.",
            status: "Upcoming",
        ...
        },
        {
            ...
            description: "Design and build a cross-platform mobile application in 48 hours.",
            status: "Ongoing",
        ...
        },
        {
            ...
            description: "Test your security skills by finding vulnerabilities in our test environment.",
            status: "Ongoing",
        ...
        },
        {
            ...
            description: "Analyze complex datasets and build predictive models to solve real-world problems.",
            status: "Completed",
    ...
    const filteredHackathons = useMemo(() => {
        ...
        return filtered;
    }, [activeTab, searchQuery, allHackathons]);
